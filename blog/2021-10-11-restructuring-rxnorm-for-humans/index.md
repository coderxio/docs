---
slug: restructuring-rxnorm-for-humans
title: Restructuring RxNorm for humans
authors: [joeylegrand]
tags: [rxnorm, drug-data, healthcare, database]
---
...
2. [RxNorm Term Types](https://www.nlm.nih.gov/research/umls/rxnorm/docs/appendix5.html)
3. [RxNorm Relationships](https://www.nlm.nih.gov/research/umls/rxnorm/docs/appendix1.html)
4. [RxNorm Attributes](https://www.nlm.nih.gov/research/umls/rxnorm/docs/appendix4.html)

![The three tables available in the RxNorm Current Prescribable Content release.](./image1-rxnorm-tables.png)
<!-- truncate -->
...
RxNorm was created based a ["need for a single, standard, multipurpose terminology for representing medications"](https://academic.oup.com/jamia/article/18/4/441/734170). It has definitely achieved that, and in doing so, has also become a reliable source of drug information. Computers and researchers (who, I know, are also humans) apparently don't have an issue with the way the data is stored, but as a clinical and technical person who is familiar with how most relational databases are structured, I would prefer to have the same valuable information presented in a different format.
...
![Reimagining the structure of RxNorm data using a familiar relational database structure.](./image2-reimagined-structure.png)
