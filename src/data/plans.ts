...
export const openPlan = {
  ...
  cta: { kind: 'link' as const, label: 'Get Started', to: '/open' },
};
...
export const enterprisePlan = {
  ...
  description:
    'The full CodeRx Drug Database — every table, every column, refreshed weekly and delivered to your S3 bucket.',
  featured: true,
  cta: {
    kind: 'demo' as const,
    label: 'Book a Demo',
...
export const featureRows: FeatureRow[] = [
  {
    ...
    open: { kind: 'text', value: 'Once per year' },
  ...
  },
  {
    ...
    open: { kind: 'text', value: 'Only prescribable drugs' },
    enterprise: { kind: 'text', value: 'All drugs' },
  },
  {
    id: 'packages',
    name: 'Packages (NDCs)',
    ...
    open: { kind: 'text', value: 'Limited columns' },
    enterprise: { kind: 'text', value: 'All packages and columns' },
  },
  {
    id: 'classes',
    name: 'Classes',
    ...
    open: { kind: 'text', value: 'Limited columns' },
    enterprise: { kind: 'text', value: 'All classification data' },
  },
  {
    id: 'ingredients',
    name: 'Ingredients',
  ...
  },
  {
    ...
    name: 'Delivery',
    detail:
      'Open is an emailed download of CSV and Parquet files. Enterprise is delivered weekly to a version-controlled S3 bucket you own, ready to load into Snowflake, DuckDB, Postgres, or whatever you already run.',
    open: { kind: 'text', value: 'Download' },
    enterprise: { kind: 'text', value: 'Weekly S3 (CSV and Parquet)' },
  },
  {
    id: 'support',
    name: 'Support',
    ...
    open: { kind: 'text', value: 'Community Slack' },
    enterprise: { kind: 'text', value: 'Dedicated support' },
  },
];
