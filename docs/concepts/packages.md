...
| `activation_date` | The date this NDC first appeared in RxNorm historical data, based on the earliest start date across all historical records for the NDC. Null if the NDC has no historical records. | |
